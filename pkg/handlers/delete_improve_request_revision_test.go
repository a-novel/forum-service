...
func TestDeleteImproveRequestRevisionHandler(t *testing.T) {
	data := []struct {
		name string
	...
	for _, d := range data {
		t.Run(d.name, func(t *testing.T) {
			service := servicesmocks.NewDeleteImproveRequestRevisionService(t)
			...
			handler := handlers.NewDeleteImproveRequestRevisionHandler(service)
			handler.Handle(c)
