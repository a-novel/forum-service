...
type mockConstructorTestingTNewListImproveSuggestionsService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewListImproveSuggestionsService(t mockConstructorTestingTNewListImproveSuggestionsService) *ListImproveSuggestionsService {
