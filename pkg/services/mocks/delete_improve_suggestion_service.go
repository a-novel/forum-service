...
type mockConstructorTestingTNewDeleteImproveSuggestionService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewDeleteImproveSuggestionService(t mockConstructorTestingTNewDeleteImproveSuggestionService) *DeleteImproveSuggestionService {
