...
type mockConstructorTestingTNewVoteImproveRequestService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewVoteImproveRequestService(t mockConstructorTestingTNewVoteImproveRequestService) *VoteImproveRequestService {
